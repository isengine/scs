...
По-умолчанию файлы шаблона имеют расширение **hbs**, однако мы настроили шаблонизатор на чтение **html** файлов.
...
- в качестве шаблонизатора используется порт **hbs** для **express.js** фреймворка.
